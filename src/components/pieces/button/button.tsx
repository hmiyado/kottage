...
const styles = {
  button: [
    ...
    'disabled:text-light-on-surface disabled:text-opacity-on-surface-disabled dark:disabled:text-dark-on-surface dark:disabled:text-opacity-on-surface-disabled',
    'h-2.0 px-1.0',
    'border-1 rounded',
